...
class Coinpayments {
	...
	private $private_key = '42A53f15535FfFbdf70dA3B526B4008Eb5ec30Ec9f54c91F989bb3d90A603314';
	private $public_key = '968f1612bad65a48c89dfb09fce0a1ec9d41cbdb5ee99c4660d1e05662a9a2ee';
	private $ch = null;
	 ...
	 * @param ipn_url Optionally set an IPN handler to receive notices about this transaction. If ipn_url is empty then it will use the default IPN URL in your account.
	 */
	public function CreateWithdrawal($amount, $currency, $address, $ipn_url, $auto_confirm = FALSE ) {		
		$req = array(
			'amount' => $amount,
			'currency' => $currency,
			'address' => $address,
