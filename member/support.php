...
<label for="pillSelect"><strong style="color:#000;">Select Type</strong></label>
...
<div class="form-group">
<label for="pillInput"><strong style="color:#000;">Subject</strong></label>
<input type="text" class="form-control input-pill" id="subject" name="subject" placeholder="Enter Subject" required>
</div>

<div class="form-group">
<label for="pillInput"><strong style="color:#000;">Description</strong></label>
