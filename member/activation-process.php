...
if($nump>0)
{
$sql1="UPDATE `ee_member` SET `paystatus`='A',`approved`='".date('Y-m-d')."',`epin`='".trim(mysqli_real_escape_string($conn,$_POST['epin']))."' WHERE `id`='".trim(mysqli_real_escape_string($conn,$_SESSION['mid']))."'";
