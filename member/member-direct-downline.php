...
<td align="center"><?php if($fetch['status']=='A'){?><a style="color:#009900;">Active</a><?php }else{?> <a style="color:#FF0000;">Inactive</a><?php }?></td>
<td align="center"><?php if($fetch['paystatus']=='I'){?><a style="color:#FF0000;">Pending</a><?php }else{?><a style="color:#009900;">Paid</a><?php }?></td>
