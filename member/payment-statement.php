...
<td align="center"><?=$fetch['invoice']?></td>
<td align="center"><?=$fetch['type']?></td>
<td align="center"><?=$fetch['amount']?></td>
<td align="center"><?=$fetch['txn_id']?></td>
<td align="center"><?=$fetch['coinamt']?></td>
<td align="center"><?=$fetch['paywallet']?></td>
<td align="center"><?php if($fetch['status']=='C'){?><a style="color:#006600;">Paid</a><?php }else{?><a style="color:#FF0000;">Pending</a><?php }?></td>
