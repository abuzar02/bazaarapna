...
<h3 align="center">Package: <?=getSettingsPackage($conn,getMember($conn,$_SESSION['mid'],'package'),'package')?> (<?=getSettingsPackage($conn,getMember($conn,$_SESSION['mid'],'package'),'amount')?>)</h3>
