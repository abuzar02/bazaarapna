...
<?php if(isset($_REQUEST['m'])=='1'){?><div align="center" style="color:#009900;font-weight:bold;">Member account is successfully activated!</div><?php } ?>
<?php if(isset($_REQUEST['e'])=='2'){?><div align="center" style="color:#FF0000;">Invalid User ID OR User ID is already activated!</div><?php } ?>
...
<?php if($_REQUEST['m']=='1'){?><div align="center" style="color:#009900;font-weight:bold;">Member account is successfully activated!</div><?php } ?>
<?php if($_REQUEST['e']=='1'){?><div align="center" style="color:#FF0000;">Invalid Epin. Enter valid Epin!</div><?php } ?>
...
?>
<div align="center" style="color:#FF0000; padding-bottom:5px;font-size:24px;"><?=getSettingsPackage($conn,$pack,'package')?> (<?=getSettingsPackage($conn,$pack,'amount')?>)</div>
...
<div class="form-group">
<label for="pillInput"><strong style="color:#000;">Epin</strong></label>
