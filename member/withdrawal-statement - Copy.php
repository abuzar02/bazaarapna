...
<td align="center"><?=$fetch['payeer']?></td>
<td align="center"><?=$fetch['paypal']?></td>
<td align="center"><?=$fetch['perfectmoney']?></td>
<td align="center"><?=$fetch['paytm']?></td>
<td align="center"><?=$fetch['upi']?></td>
...
<?php $i++;}}else{?>
<tr><td colspan="17" align="center" style="color:#FF0000;">No Record Found!</td></tr>
<?php }?>
</tbody>
</table>
