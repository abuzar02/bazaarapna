...
<h4 class="card-title">Member Package Statement</h4>
...
<div align="right" style="padding:5px;"><form name="frm1" method="post" action="member-package.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:150px;" />
</form></div>
...
<?php
$tname='ee_member_package';
$lim=100;
$tpage='member-package.php';
...
<td align="center" style="padding:3px;"><?=$fetch['remarks']?></td>
